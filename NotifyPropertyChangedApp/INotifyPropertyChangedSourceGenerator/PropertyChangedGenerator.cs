...
namespace INotifyPropertyChangedSourceGenerator
{
    ...
    public class PropertyChangedGenerator : ISourceGenerator
    {
        ...
        {
            context.RegisterForPostInitialization(postInitContext => postInitContext.AddSource("AutoGenerateAttribute.g.cs",
                SourceText.From(@"
/// <auto-generated/>
#nullable enable
using System;
    ...
    sealed class AutoNotifyAttribute : Attribute
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            foreach (var implementationToGenerate in implementationsToGenerate)
            {
                ...
                context.AddSource(implementationToGenerate.Type.Name + ".g.cs", SourceText.From(implementation, Encoding.UTF8));
            }
        }
